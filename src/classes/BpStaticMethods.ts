...
export abstract class BpStaticMethods {
     ...
     **/
    public static makeConnection(entity1: IBpConnectable & BpEntity, entity2: IBpConnectable & BpEntity, port: TBpEntityConnectionPort, destinationPort: TBpEntityConnectionPort, cable: CableColors): void {
