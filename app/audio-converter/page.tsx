            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <div className="flex items-start mb-3">
                  <div className="bg-cyan-500 rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">1</div>
                  <p>Select an instrument from the top row to activate it</p>
                </div>
                <div className="flex items-start mb-3">
                  <div className="bg-cyan-500 rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">2</div>
                  <p>Click on the grid cells to activate/deactivate steps for each instrument</p>
                </div>
              </div>
              <div>
                <div className="flex items-start mb-3">
                  <div className="bg-cyan-500 rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">3</div>
                  <p>Adjust BPM to control the tempo of your composition</p>
                </div>
                <div className="flex items-start">
                  <div className="bg-cyan-500 rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0">4</div>
