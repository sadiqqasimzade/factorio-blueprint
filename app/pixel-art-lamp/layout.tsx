...
export const metadata: Metadata = {
    ...
    keywords: ['pixel art to factorio lamp blueprint converter', 'factorio lamp blueprint converter', 'factorio lamp blueprint', 'factorio lamp', 'factorio', 'blueprint', 'converter', 'image', 'lamp', 'blueprint', 'converter'],
    alternates: {
