        ...
        <>
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-4 items-center md:flex-row flex-col">
                    <input type="file" accept="video/*,.gif" className="text-black bg-white px-2 py-1 rounded-md cursor-pointer" onChange={(e) => {
                ...
                <div className="flex gap-6 justify-between md:flex-row flex-col">
                    <div className="flex flex-col gap-2 w-full">
                        <label>Width</label>
                        <input type="number" className="text-black bg-white px-2 py-1 rounded-md" value={width} onChange={(e) => {
                    ...
                    <div className="flex flex-col gap-2 w-full">
                        <label>Height</label>
                        <input type="number" className="text-black bg-white px-2 py-1 rounded-md" value={height} onChange={(e) => {
                    ...
                    <div className="flex flex-col gap-2 w-full">
                        ...
                        <input type="number" className="text-black bg-white px-2 py-1 rounded-md" value={skippedFrames} min={0} onChange={(e) => {
                            setSkippedFrames(Number(e.target.value))
                        }} />
                        <label>Skip some frames to achieve smaller result.Screen UPS will change to maintain original speed</label>
                    </div>
                    <div className="flex flex-col gap-2 w-full">
                        <label>Screen UPS</label>
                        <input type="number" className="text-black bg-white px-2 py-1 rounded-md" value={screenUps} min={1} max={60} onChange={(e) => {
                            setScreenUps(Number(e.target.value))
                        }} />
                        <label>Max value 60</label>
                    </div>
                    <div className="flex flex-row gap-2 items-start w-full">
                        <label>Loop without blank frame <input type="checkbox" className="text-black bg-white px-2 py-1 rounded-md" checked={loopWithoutBlankFrame} onChange={(e) => {
